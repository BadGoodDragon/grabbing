...
public class AccountLogInActivity extends AppCompatActivity implements ActivitiesActions{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button register = findViewById(R.id.account_log_in_button_log_in);
        TextInputLayout username = findViewById(R.id.account_log_in_text_input_layout_username);
        TextInputLayout password = findViewById(R.id.account_log_in_text_input_layout_password);
    }
